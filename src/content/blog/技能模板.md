...
## 实际案例
本次对话用于工程需求头脑风暴阶段。
你可以阅读项目代码、Reference 文件夹以及 `AGENTS.md` 文档以获取背景信息。
...
请使用规范提交信息，便于代码追踪与团队协作。

把项目约定整理到 `AGENTS.md` 里之后，后续碰到流程、风格或边界问题时，就可以继续让 AI 优先参考并更新这个文件。当然有时候即使说了，它还是会犯错，这也和模型能力、上下文长度有关。
