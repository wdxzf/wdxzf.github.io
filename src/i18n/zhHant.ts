export  const zhHant = {
  ...
  'memos.loadMore': '加載更多',
  'memos.loading': '正在加載動態...',
  'memos.empty': '暫時還沒有公開動態。',
  'memos.error': '動態加載失敗，請稍後再試。',
  'memos.configMissing': 'Memos 配置缺失，暫時無法展示動態。',
  ...
  'search.placeholderBasic': '輸入標題、摘要、標籤或分類關鍵字',
  'search.placeholderContent': '輸入標題、摘要或正文關鍵字',
  'search.hintBasic': '支持搜索標題、摘要、標籤和分類，按 / 快速聚焦',
  'search.hintContent': '支持全文搜索，按 / 快速聚焦',
  'search.loading': '正在加載搜索索引...',
  'search.error': '搜索索引加載失敗，請稍後再試。',
